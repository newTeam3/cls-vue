  ...
  <div>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      ...
      <el-form-item>
        ...
        <el-button size="small" type="primary" icon="el-icon-plus" @click="handleEdit()" >发布新公告</el-button>
...
<script>
  ...
  import { findAllNotice,addNotice,updateNotice,banNotice,banRows } from '@/api/task'
  export default {
    name: "Notice",
